...
use types::providers::{DmarcResult, ScoringAction, ScoringResult, ThreatIndicatorType, ThreatIntelObservation, ThreatSeverity};
...
impl RspamdAbuseProvider {
    pub fn new(host: String, port: u16, password: String, bayes_path: String) -> Self {
        Self {
            config: RspamdConfig { host, port, password, bayes_path },
        }
    }
}
